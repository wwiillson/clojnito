...
* [`src/clojnito/`](src/clojnito/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/clojnito/core.cljs): contains the SPA entry point, `init`
* [`test/clojnito/`](test/clojnito/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `clojnito` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/clojnito/config.cljs) defaults to `true` in
